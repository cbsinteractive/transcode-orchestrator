	...
	var tests = []struct {
		...
		},
		{
				...
				Preset: Preset{
					...
					Video: VideoPreset{
						...
						HDR10Settings: HDR10Settings{
							...
							MaxCLL:        10000,
							MaxFLL:        400,
							MasterDisplay: "G(8500,39850)B(6550,2300)R(35400,14600)WP(15635,16450)L(100000000000,0)",
						},
					},
					Audio: AudioPreset{
						Codec:   "aac",
			...
			map[string]interface{}{
				...
				"preset_video_hdr10_enabled":       "true",
				"preset_video_hdr10_maxcll":        "10000",
				"preset_video_hdr10_maxfll":        "400",
				"preset_video_hdr10_masterdisplay": "G(8500,39850)B(6550,2300)R(35400,14600)WP(15635,16450)L(100000000000,0)",
				"preset_audio_bitrate":             "64000",
				"preset_audio_codec":               "aac",
			},
		},
		{
			description: "a preset containing a video section with no HDR metadata, results in no fields mapped for HDR",
			hash: LocalPreset{
				Preset: Preset{
					Name: "no HDR",
					Video: VideoPreset{
